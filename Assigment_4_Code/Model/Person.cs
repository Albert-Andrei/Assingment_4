...
namespace Assigment_4_Code.Model
{
    public class Person
    {
        ...
        [Required, MaxLength(20)] [NotNull] [JsonPropertyName("firstName")] public string FirstName { get; set; }
        [NotNull] [Required, MaxLength(30)] [JsonPropertyName("lastName")] public string LastName { get; set; }
        [ValidHairColor] [Required] [JsonPropertyName("hairColor")] public string HairColor { get; set; }
        [NotNull] [ValidEyeColor] [Required] [JsonPropertyName("eyeColor")] public string EyeColor { get; set; }
        [NotNull, Range(1, 125)][Required] [JsonPropertyName("age")] public int Age { get; set; }
        [NotNull, Range(1, 250)][Required] [JsonPropertyName("weight")] public float Weight { get; set; }
        [NotNull, Range(30, 250)][Required] [JsonPropertyName("height")] public int Height { get; set; }
